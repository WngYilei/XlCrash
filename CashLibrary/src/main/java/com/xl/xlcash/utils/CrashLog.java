...
public class CrashLog {
    ...
    private static Map<String, String> collectDeviceInfo(Context ctx) {
        ...
        infos.put("ATotalMemory",DeviceInfoManager.getTotalMemory()+"");
        infos.put("AvailableMemory",DeviceInfoManager.getAvailableMemory(ctx)+"");
       return infos;
    }
    ...
    public static String crashLogDir() {
        return Environment.getExternalStorageDirectory().toString() + "/zity/log/cashLog/";
    }

    public static String getExceptionMsg(Context context, Throwable ex) {
